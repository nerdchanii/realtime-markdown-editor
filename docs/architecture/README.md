...
제품 기능의 사용자 행동 지도는 `docs/archive/compliance/feature-acceptance-map.md`에서 확인한다. 중요한
...
7. `docs/archive/compliance/feature-acceptance-map.md`
8. `docs/adr/*`
...
- Feature acceptance map은 `docs/archive/compliance/feature-acceptance-map.md`에서 관리한다.
