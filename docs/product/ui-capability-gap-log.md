...
| UI-GAP-008 | Trash                     | Left sidebar shows Trash button but it does nothing.                      | Document soft-delete, archive, and recovery workflows.                                 | `REQ-DOCUMENT-TRASH-RESTORE`                                                                                 | open   |
