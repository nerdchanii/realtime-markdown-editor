...
| ---------- | -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------ |
| UI-GAP-001 | Profile menu / settings    | Profile menu opens scoped User, Workspace, and Project settings with persisted account/workspace/project/member edits where supported. | Remaining workspace lifecycle UX beyond member management.                                         | `REQ-WORKSPACE-LIFECYCLE-MANAGEMENT`                                      | open   |
