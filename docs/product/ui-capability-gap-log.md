...
| ---------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------ |
| UI-GAP-001 | Profile menu / settings    | Profile menu opens scoped User, Workspace, and Project settings with persisted account/workspace/project edits where supported. | Remaining workspace/member management UX.                                                          | `REQ-WORKSPACE-LIFECYCLE-MANAGEMENT`, `REQ-WORKSPACE-MEMBER-MANAGEMENT`   | open   |
