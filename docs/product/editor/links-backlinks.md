...
- Link behavior가 rich editor authoring과 export와 호환되게 한다.
...
- The projection is separate from Markdown body storage: the rich editor preserves standard Markdown link semantics through export.
