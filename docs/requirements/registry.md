...
| `REQ-WORKSPACE-DOCUMENT-SCOPE` | subject-derived | functional | confirmed | walking-skeleton | `CE-01-CONCURRENT-EDITING` | Collaborative editing은 anonymous single-page scratch document가 아니라 workspace document 기준으로 검증한다. | review를 위한 seeded 또는 real workspace/project/folder/document context가 존재한다. | `docs/product/workspace/workspace-hierarchy.md` | ADR-0001, ADR-0005 |
...
| id | origin | type | decision_status | delivery_phase | derived_from | statement | acceptance | related_product_docs | related_adrs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `REQ-WORKSPACE-HIERARCHY` | product-extension | functional | confirmed | mvp | `subject.md free area` | 제품은 `Workspace > Project > Folder > Document`를 model로 삼는다. | seeded data가 최소여도 navigation과 data language가 hierarchy를 보존한다. | `docs/product/workspace/workspace-hierarchy.md`, `docs/domain/models/workspace.md` | ADR-0001, ADR-0005 |
