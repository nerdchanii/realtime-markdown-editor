...
| 2026-09-26 | UI lint 는 ratchet 이다. 현재 위반 186건을 파일별 baseline 으로 두고, 새 위반과 증가를 막는다. baseline 은 낮추는 방향으로만 갱신한다 | G1 | agent:claude-code | pending | 2026-10-03 | 규칙이 정당한 코드를 과하게 막으면 | #7 PR |
